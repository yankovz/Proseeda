...
export default class JqxResponsivePanel extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxResponsivePanel' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['animationDirection','animationHideDelay','animationShowDelay','animationType','autoClose','collapseBreakpoint','collapseWidth','height','initContent','theme','toggleButton','toggleButtonSize','width'];
        let options = {};
