...
export default class JqxBarGauge extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxBarGauge' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['animationDuration','backgroundColor','barSpacing','baseValue','colorScheme','customColorScheme','disabled','endAngle','formatFunction','height','labels','max','min','relativeInnerRadius','rendered','startAngle','title','tooltip','useGradient','values','width'];
        let options = {};
