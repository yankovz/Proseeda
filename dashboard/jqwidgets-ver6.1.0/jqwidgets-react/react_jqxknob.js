...
export default class JqxKnob extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxKnob' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['allowValueChangeOnClick','allowValueChangeOnDrag','allowValueChangeOnMouseWheel','changing','dragEndAngle','dragStartAngle','disabled','dial','endAngle','height','labels','marks','min','max','progressBar','pointer','pointerGrabAction','rotation','startAngle','spinner','style','step','snapToStep','value','width'];
        let options = {};
