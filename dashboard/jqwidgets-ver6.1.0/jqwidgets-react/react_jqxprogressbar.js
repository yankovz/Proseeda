...
export default class JqxProgressBar extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxProgressBar' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['animationDuration','colorRanges','disabled','height','layout','max','min','orientation','rtl','renderText','showText','template','theme','value','width'];
        let options = {};
