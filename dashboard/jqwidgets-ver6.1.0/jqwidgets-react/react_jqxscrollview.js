...
export default class JqxScrollView extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxScrollView' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['animationDuration','bounceEnabled','buttonsOffset','currentPage','disabled','height','moveThreshold','showButtons','slideShow','slideDuration','theme','width'];
        let options = {};
