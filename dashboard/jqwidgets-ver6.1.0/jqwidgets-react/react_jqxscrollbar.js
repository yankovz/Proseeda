...
export default class JqxScrollBar extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxScrollBar' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['disabled','height','largestep','min','max','rtl','step','showButtons','thumbMinSize','theme','vertical','value','width'];
        let options = {};
