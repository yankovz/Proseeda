...
export default class JqxNavigationBar extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxNavigationBar' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['animationType','arrowPosition','collapseAnimationDuration','disabled','expandAnimationDuration','expandMode','expandedIndexes','height','initContent','rtl','showArrow','theme','toggleMode','width'];
        let options = {};
