...
export default class JqxFormattedInput extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxFormattedInput' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['disabled','decimalNotation','dropDown','dropDownWidth','height','min','max','placeHolder','popupZIndex','roundedCorners','rtl','radix','spinButtons','spinButtonsStep','template','theme','upperCase','value','width'];
        let options = {};
