...
export default class JqxListMenu extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxListMenu' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['alwaysShowNavigationArrows','animationType','animationDuration','autoSeparators','backLabel','disabled','enableScrolling','filterCallback','height','headerAnimationDuration','placeHolder','readOnly','rtl','roundedCorners','showNavigationArrows','showFilter','showHeader','showBackButton','theme','width'];
        let options = {};
