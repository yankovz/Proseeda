...
export default class JqxBulletChart extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxBulletChart' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['animationDuration','barSize','description','disabled','height','labelsFormat','labelsFormatFunction','orientation','pointer','rtl','ranges','showTooltip','target','ticks','title','tooltipFormatFunction','width'];
        let options = {};
