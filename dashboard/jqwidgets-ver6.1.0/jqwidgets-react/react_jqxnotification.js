...
export default class JqxNotification extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxNotification' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['appendContainer','autoOpen','animationOpenDelay','animationCloseDelay','autoClose','autoCloseDelay','blink','browserBoundsOffset','closeOnClick','disabled','height','hoverOpacity','icon','notificationOffset','opacity','position','rtl','showCloseButton','template','theme','width'];
        let options = {};
