...
export default class JqxRepeatButton extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxRepeatButton' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['delay','disabled','height','imgSrc','imgWidth','imgHeight','imgPosition','roundedCorners','rtl','textPosition','textImageRelation','theme','template','toggled','width','value'];
        let options = {};
