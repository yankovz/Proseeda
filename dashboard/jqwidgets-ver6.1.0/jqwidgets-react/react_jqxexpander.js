...
export default class JqxExpander extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxExpander' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['animationType','arrowPosition','collapseAnimationDuration','disabled','expanded','expandAnimationDuration','height','headerPosition','initContent','rtl','showArrow','theme','toggleMode','width'];
        let options = {};
