...
export default class JqxRibbon extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxRibbon' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['animationType','animationDelay','disabled','height','initContent','mode','popupCloseMode','position','rtl','selectedIndex','selectionMode','scrollPosition','scrollStep','scrollDelay','theme','width'];
        let options = {};
