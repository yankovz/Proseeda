...
export default class JqxTextArea extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxTextArea' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['disabled','displayMember','dropDownWidth','height','items','maxLength','minLength','opened','placeHolder','popupZIndex','query','renderer','roundedCorners','rtl','scrollBarSize','searchMode','source','theme','valueMember','width'];
        let options = {};
