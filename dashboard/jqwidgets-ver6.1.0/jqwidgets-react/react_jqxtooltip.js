...
export default class JqxTooltip extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxTooltip' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['absolutePositionX','absolutePositionY','autoHide','autoHideDelay','animationShowDelay','animationHideDelay','content','closeOnClick','disabled','enableBrowserBoundsDetection','height','left','name','opacity','position','rtl','showDelay','showArrow','top','trigger','theme','width'];
        let options = {};
