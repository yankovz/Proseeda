...
export default class JqxComplexInput extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxComplexInput' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['decimalNotation','disabled','height','placeHolder','roundedCorners','rtl','spinButtons','spinButtonsStep','template','theme','value','width'];
        let options = {};
