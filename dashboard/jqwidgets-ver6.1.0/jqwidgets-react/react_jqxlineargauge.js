...
export default class JqxLinearGauge extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxLinearGauge' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['animationDuration','background','colorScheme','disabled','easing','height','int64','labels','min','max','orientation','pointer','rangesOffset','rangeSize','ranges','showRanges','scaleStyle','scaleLength','ticksOffset','ticksPosition','ticksMinor','ticksMajor','value','width'];
        let options = {};
