...
export default class JqxRadioButton extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxRadioButton' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['animationShowDelay','animationHideDelay','boxSize','checked','disabled','enableContainerClick','groupName','hasThreeStates','height','rtl','theme','width'];
        let options = {};
