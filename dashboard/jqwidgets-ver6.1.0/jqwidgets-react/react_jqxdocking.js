...
export default class JqxDocking extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxDocking' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['cookies','cookieOptions','disabled','floatingWindowOpacity','height','keyboardNavigation','mode','orientation','rtl','theme','width','windowsMode','windowsOffset'];
        let options = {};
