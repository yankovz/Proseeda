...
export default class JqxNavBar extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxNavBar' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['columns','disabled','height','minimized','minimizeButtonPosition','minimizedHeight','minimizedTitle','orientation','popupAnimationDelay','rtl','selection','selectedItem','theme','width'];
        let options = {};
