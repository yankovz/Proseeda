...
export default class JqxNumberInput extends React.Component {
    constructor(props) {
        super(props);
        const widgetId = 'jqxNumberInput' + JQXLite.generateID();
    ...
    manageAttributes() {
        const properties = ['allowNull','decimal','disabled','decimalDigits','decimalSeparator','digits','groupSeparator','groupSize','height','inputMode','min','max','negativeSymbol','placeHolder','promptChar','rtl','readOnly','spinMode','spinButtons','spinButtonsWidth','spinButtonsStep','symbol','symbolPosition','textAlign','template','theme','value','width'];
        let options = {};
